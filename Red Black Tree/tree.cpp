...
template <typename T>
RedBlackTree<T>::Node::Node(T data, COLOR color, Node* left, Node* right, Node* parent)
...
template <typename T>
void RedBlackTree<T>::fix_insert(Node*& node) {
    Node* parent = nullptr;
...
template <typename T>
void RedBlackTree<T>::fix_delete(Node*& node) {
...
template <typename T>
typename RedBlackTree<T>::Node* RedBlackTree<T>::min_value_node(Node* node) {
    Node* current = node;
